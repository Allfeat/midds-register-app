...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    musicalWorks: {
      pendingMidds: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<PalletMiddsMiddsWrapperSong>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<MelodieRuntimePalletsSessionSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, MelodieRuntimePalletsSessionSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    stakeholders: {
      pendingMidds: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<PalletMiddsMiddsWrapperStakeholder>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
