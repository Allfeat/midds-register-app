...
declare module '@polkadot/api-base/types/errors' {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    ...
    musicalWorks: {
       ...
       **/
      CantHoldFunds: AugmentedError<ApiType>;
      /**
       * Funds can't be released at this moment.
       **/
      CantReleaseFunds: AugmentedError<ApiType>;
      /**
       * A MIDDS with the same hash ID (so the same data) is already registered.
       **/
      MiddsDataAlreadyExist: AugmentedError<ApiType>;
      /**
       ...
       **/
      OverflowedAuthorizedDataCost: AugmentedError<ApiType>;
      /**
       * The specified MIDDS ID is not related to any pending MIDDS.
       **/
      PendingMiddsNotFound: AugmentedError<ApiType>;
      /**
       * The lock-unregister period is still going.
       **/
      UnregisterLocked: AugmentedError<ApiType>;
      /**
       * Generic error
       **/
      [key: string]: AugmentedError<ApiType>;
