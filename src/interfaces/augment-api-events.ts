...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    musicalWorks: {
      MIDDSRegistered: AugmentedEvent<ApiType, [provider: AccountId32, hashId: H256, dataColateral: u128], { provider: AccountId32, hashId: H256, dataColateral: u128 }>;
      MIDDSUnregistered: AugmentedEvent<ApiType, [hashId: H256], { hashId: H256 }>;
      MIDDSUpdated: AugmentedEvent<ApiType, [hashId: H256], { hashId: H256 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: MelodieRuntimePalletsProxyProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: MelodieRuntimePalletsProxyProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: MelodieRuntimePalletsProxyProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: MelodieRuntimePalletsProxyProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: MelodieRuntimePalletsProxyProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: MelodieRuntimePalletsProxyProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    system: {
       ...
       **/
      TaskCompleted: AugmentedEvent<ApiType, [task: MelodieRuntimeRuntimeTask], { task: MelodieRuntimeRuntimeTask }>;
      /**
       * A [`Task`] failed during execution.
       **/
      TaskFailed: AugmentedEvent<ApiType, [task: MelodieRuntimeRuntimeTask, err: SpRuntimeDispatchError], { task: MelodieRuntimeRuntimeTask, err: SpRuntimeDispatchError }>;
      /**
       * A [`Task`] has started executing
       **/
      TaskStarted: AugmentedEvent<ApiType, [task: MelodieRuntimeRuntimeTask], { task: MelodieRuntimeRuntimeTask }>;
      /**
